...
som_stats = {"qe": [round(tensor.item(), 5) for tensor in som.all_quant_err], "wd": [round(i, 5) for i in som.all_winner], "e": [round(tensor.item(), 5) for tensor in som.all_entr], "dist":[round(i, 5) for i in som.all_dists]}
